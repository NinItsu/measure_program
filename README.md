...
測定は測定信号生成，暗騒音測定，スピーカのウォーミングアップ，インパルス応答測定，SNRの確認（20 dBより低い場合は警告が表示され，そのインパルス応答もfigureに表示される），ファイル保存の順番で行われる（以下のMeasProg_turntableとMeasProg_actuatorも同様）  
...
実際保存されたファイル名は  
インパルス応答: \IR\ファイル名-信号種類信号振幅-L_インパルス応答長_LSPNO_スピーカ数_MICNO_マイクロホン数_TRIAL測定回数.float  
部屋暗騒音: \BGN\ファイル名-_MICNO_マイクロホン数_TRIAL測定回数.float  
生録音データ: \RAW日付\ファイル名-信号種類信号振幅-L_インパルス応答長_LSPNO_スピーカ数_MICNO_マイクロホン数_TRIAL測定回数.float  
...
実際保存されたファイル名は  
インパルス応答: \IR\ファイル名-信号種類信号振幅-L_インパルス応答長_LSPNO_スピーカ数_MICNO_マイクロホン数_ANG_角度_TRIAL測定回数.float  
部屋暗騒音: \BGN\ファイル名-_MICNO_マイクロホン数_TRIAL測定回数.float  
生録音データ: \RAW日付\ファイル名-信号種類信号振幅-L_インパルス応答長_LSPNO_スピーカ数_MICNO_マイクロホン数_ANG_角度_TRIAL測定回数.float  
## MeasProg_actuator.m
...
実際保存されたファイル名は  
インパルス応答: \IR\ファイル名-信号種類信号振幅-L_インパルス応答長_LSPNO_スピーカ数_MICNO_マイクロホン数_X_x軸座標_Z_z軸座標_TRIAL測定回数.float  
部屋暗騒音: \BGN\ファイル名-_MICNO_マイクロホン数_TRIAL測定回数.float  
（ファイル容量の問題で生録音データは保存しない）
## testLSP.m  
スピーカの音出し確認  
#### 使用方法：  
関数testLSPを呼び出す  
